...
public class DriveSubsystem extends SubsystemBase {
  ...
  public void drive(double xSpeed, double ySpeed, double rot, boolean fieldRelative) {
    ...
    m_frontLeft.setDesiredState(swerveModuleStates[0]); //Working as 1 - 0
    m_frontRight.setDesiredState(swerveModuleStates[1]); //Working as 0 - 1
    m_rearLeft.setDesiredState(swerveModuleStates[2]); //Working as 3 - 2
    m_rearRight.setDesiredState(swerveModuleStates[3]); //Working as 2 - 3
  }
